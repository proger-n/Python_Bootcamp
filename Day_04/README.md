...
A script that had to be injected into a web page:
...
Thus, your code should convert ["todo.yml"](Day_04/materials/todo.yml) into "deploy.yml" following this notation.
